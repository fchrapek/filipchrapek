...
import { rehypeLazyImages } from "../theme/src/plugins/rehype-lazy-images";
// Remark plugins
import remarkDirective from "remark-directive"; /* Handle ::: directives as nodes */
import { remarkAdmonitions } from "../theme/src/plugins/remark-admonitions"; /* Add admonitions */
import { remarkGithubCard } from "../theme/src/plugins/remark-github-card";
import { remarkReadingTime } from "../theme/src/plugins/remark-reading-time";
...
export default defineConfig({
  ...
  integrations: [
    ...
    webmanifest({
      ...
      short_name: "Filip_Chrapek", // optional
      description: siteConfig.description,
      lang: siteConfig.lang,
      // icon: "public/icon.svg", // the source for generating favicon & icons - commented out to use custom PNGs
      icons: [
        {
